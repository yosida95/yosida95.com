...
この記事は昨年書いた「 `Zabbix のメディアタイプに Growl を指定し、手元のマシンの Growl で障害情報を受け取る方法 </2013/05/27/005303.html>`__\ 」の焼き直しです。
...
より詳細な設定手順は `Zabbix のメディアタイプに Growl を指定し、手元のマシンの Growl で障害情報を受け取る方法 </2013/05/27/005303.html>`__ を参照してください。
